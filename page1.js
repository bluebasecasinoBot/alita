...
__SYD.p1 = () =>{
    return __c(
        "div",
        {
            style:`height:fit-content;width:100%;min-height:fit-content;padding-top:150px;padding-bottom:20px;display:flex;justify-content:center;background-image:url("./assets/mainOverlay.png");background-attachment:fixed;`,
            id:"p1"
        },
        [
            __SYD.p1SubHeader()
...
__SYD.p1SubHeader = () =>{
    return  __c(
        "div",
        {
            style:`height:100%;width:100%;max-width:1300px;display:flex;align-items:center;gap:10px;padding:0 ${__p(["p1SubHeader" , "mobilePadState"],false) ? "10px" : "60px"};flex-direction:${__p(["p1SubHeader" , "breakVal"],false) ? "column" : "row"}`
        },
        [
            __c(
                "div",
                {
                    style:`height:fit-content;width:${__p(["p1SubHeader" , "breakVal"],false) ? "100%" : "50%"};display:flex;flex-direction:column;gap:20px;`
                },
                [
                    __SYD.p1_mainHeader(),
                    __SYD.p1_subText(),
...
__SYD.p1_mainHeader = () =>{
    return __c(
        "div",
        {
            ...
            text-transform:uppercase;font-weight:900;font-size:${SYD_VAR.page1MainFont_1.get()};color:#0B0A1D;font-family:font1;`
        },
        [
            __c("p" , {} , ["alita ai"])
        ]
