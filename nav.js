...
__SYD.navBar = () =>{
    return __c(
        "nav",
        {
            style:`overflow-y:hidden;min-height:90px;max-height:${__p(["navBar" , "mobileNavExpand"], false) ? "500px" : "90px"};width:90%;border:4px solid #0B0A1D;position:fixed;top:30px;left:50%;transform:translateX(-50%);border-radius:15px;padding:0 ${__p(["navBar" , "mobilePadState"], false) ? "10px" : "50px"};background: #16143a;transition:all ease-out .4s;display:flex;align-items:flex-start;z-index:999;`
        },
        [
            __SYD.navLogo(),
    ...
    return __c(
        ...
        [
            __c(
                "div",
                {
                    style:`height:fit-content;height:fit-content;margin-top:${__p(["navBar" , "mobileNavExpand"], false) ? "0px" : "0px"};padding:20px 10px;display:flex;flex-direction:column;gap:15px;background:#16143a;`
                },
                [
...
__SYD.desktopNav_button = () =>{
    return __c(
        ...
        [
            __c("p" , {style:"width:fit-content"},["get started"])
        ],
        {
            events:{
                onclick:e =>{
