...
__SYD.footer_main_parent = () =>{
    ...
    return __c(
        'div',
        {
            style:`height:fit-content;padding:${check ? "20px 50px" : "20px 10px"};padding-top:50px;padding-bottom:20px;background:${"#0B0A1D"};width:100%;display:flex;flex-direction:column;row-gap:40px;padding-bottom:150px;`,
            id:"footer"
        },
        [
            __c(
                    ...
                    __c(
                        'div',
                        {
                            ...
                            __c(
                                ...
                                [
                                    __SYD.iconify_20px({attr:'fa-brands fa-x-twitter' , clr :'rgb(138, 99, 247)'}),//<i class="fa-solid fa-envelope-open-text"></i>
                            ...
                            __c(
                                ...
                                {style:'display:flex;column-gap:10px;padding:5px;width:fit-content;align-items:center'},
                                [
                                    __SYD.iconify_20px({attr:'fa-brands fa-telegram' , clr :'rgb(138, 99, 247)'}),//<i class="fa-solid fa-phone-volume"></i>
